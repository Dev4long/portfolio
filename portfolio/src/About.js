...
function About() {
  return (
    ...
    <div className="Summary">
     ...
     tennis, and swimming. Definetly can say I am competitive by nature but can balance out working as a team 
     (which I prefer) or working independantly. I had multiple different jobs growing up ranging from being a 
     ...
     I've been looking into cloud development, as well new techs like kubernetes and docker to containerize applications. Been practicing algorithms as well and have been recently dabbling with some python. 
